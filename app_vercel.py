...
app = Flask(__name__)
app.secret_key = os.getenv('SECRET_KEY', '9LN36ZsohRVZNKd8HqPDUDBTLjr4l8oTulz769uB4zw')
...
EMAIL_PASSWORD = os.getenv('EMAIL_PASSWORD', 'awvlcrrnpktpzbuo')
...
if EMAIL_PASSWORD == 'awvlcrrnpktpzbuo':
...
def api_detect():
    ...
    try:
        ...
        # Fallback to basic analysis if comprehensive analyzer fails
        analysis_result = analyze_email_phishing(email_text, url)
